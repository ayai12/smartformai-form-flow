...
const SignUpPage: React.FC = () => {
  ...
  const locationState = location.state as { returnTo?: string; from?: { pathname?: string } | string } | null;
  const returnTo = returnToParam || 
                  locationState?.returnTo || 
                  (typeof locationState?.from === 'object' ? locationState.from?.pathname : locationState?.from) || 
                  '/pricing';
