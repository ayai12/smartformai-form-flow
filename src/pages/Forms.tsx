  ...
  return (
    <DashboardLayout>
      <div className="relative flex flex-col md:flex-row justify-between items-center mb-8 gap-4 md:gap-0">
        <div>
          <h1 className="text-3xl font-semibold text-black tracking-tight">My Survey Agents</h1>
          <p className="text-black/60 text-base mt-1.5">Manage and organize all your AI survey agents</p>
        </div>
      ...
      {forms.length >= 10 && (
        <div className="my-8 flex justify-center">
          <div className="bg-[#7B3FE4] text-white px-6 py-3 rounded-lg flex items-center gap-4">
            <span className="font-medium">Need more agents?</span>
      ...
      {sortedAndFilteredForms.length === 0 ? (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-semibold text-black mb-1">No agents found</h3>
          <p className="text-black/60 mb-4">
            {searchQuery ? `No survey agents matching "${searchQuery}"` : "You don't have any survey agents yet. Create your first AI-powered survey agent!"}
          </p>
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Delete Survey Agent</DialogTitle>
            <DialogDescription>
              Are you sure you want to delete this survey agent? This action cannot be undone and all agent data will be permanently lost.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
