        ...
        <section className="max-w-3xl mx-auto mb-16 px-4">
          <div className="rounded-3xl bg-white/80 shadow-xl p-8 md:p-12 border border-pink-100 flex flex-col gap-6">
            ...
            <p className="text-lg text-gray-700">
              What if surveys could learn on their own? Instead of you rebuilding questions and guessing what to ask next, your survey could adapt automatically based on real responses. That question led to SmartFormAI Agents — autonomous AI survey systems that build, analyze, and evolve themselves.
            </p>
          </div>
        </section>
